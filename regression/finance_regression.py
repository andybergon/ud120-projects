...
print('Against TEST')
print('R^2=', reg.score(feature_test, target_test))
...
print('Against TRAIN')
print('R^2=', reg2.score(feature_train, target_train))
print('Slope:', reg2.coef_, ' - Intercept:', reg2.intercept_)
